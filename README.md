# Senior Business Analyst | Strategy & Automation Specialist

**25 Years of Experience | Enterprise-Scale Projects | Low-Code Enthusiast**

---

## 🚀 Executive Summary
Highly seasoned **Senior Business Analyst** with a career spanning two and a half decades of bridging the gap between complex business needs and technical solutions. Currently focused on leveraging modern **AI and Low-Code Automation (n8n, Airtable)** to drive operational efficiency.
...
## 🏗 Current Projects
### [Project: Automated Job Search Pipeline]
* **Problem:** Manual tracking of high-volume job leads and recruiter interactions.
* **Solution:** Built a self-hosted **n8n** workflow that monitors Gmail, uses **OpenAI** to score job descriptions against my CV, and logs high-value leads into an **Airtable** CRM.
* **Result:** Reduced administrative overhead by 70%, allowing focus on high-priority interview prep.

---

## 📜 Career Milestones
* **Senior Business Analyst (Various Roles)** | *1999 – Present*
    * Led cross-functional teams to deliver enterprise-grade software solutions.
    * Specialist in stakeholder management, requirement elicitation, and gap analysis.
    * Expert at translating "Business Speak" into "Developer Action."

---

## 🏃 Outside the Office
When I’m not architecting workflows, you’ll find me at the gym. I’m a fitness enthusiast with a disciplined daily resistance training routine. I apply the same **"Input = Output"** logic to my nutrition and training as I do to business processes.

---

## 📫 Let's Connect
- **LinkedIn:** [Link to your profile]
- **Status:** Currently open to Senior BA / Lead BA opportunities.
